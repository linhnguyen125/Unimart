        ...
        <div class="main-content fl-right">
            <div class="section" id="list-blog-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        <li class="clearfix">
                            <a href="{{url('page/blog/detail')}}" title="" class="thumb fl-left">
                                <img src="{{asset('images/img-post-01.jpg')}}" alt="">
                            </a>
                            <div class="info fl-right">
                                <a href="{{url('page/blog/detail')}}" title="" class="title">Mời gọi kiều bào hiến kế, chung sức xây dựng phát triển TP. Hồ Chí Minh</a>
